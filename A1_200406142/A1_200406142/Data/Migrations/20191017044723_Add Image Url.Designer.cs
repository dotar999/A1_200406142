...
namespace A1_200406142.Data.Migrations
{
    ...
    [Migration("20191017044723_Add Image Url")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("A1_200406142.Models.Animal", b =>
                {
                    ...
                    b.HasData(
                        new { AnimalId = 1, Description = "Cats - incredibly cute creatures that successfully live both in houses and in the wild (instilling fear in any forest animals). And those cats who live in houses have their own slaves - people.", Name = "Cats" },
                        new { AnimalId = 2, Description = "Dogs (doge) - animals devoted to man, ready to give their lives in order to protect the owner. But be sure, if you leave the dog at house alone, it will gobble up your Sweet Roll.", Name = "Dogs" }
                    );
                });

            modelBuilder.Entity("A1_200406142.Models.Food", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("A1_200406142.Models.Food", b =>
                {
                    b.HasOne("A1_200406142.Models.Animal", "AnimalType")
                        .WithMany("Foods")
