...
namespace A1_200406142.Controllers
{
    public class ShopController : Controller
    {
        ...
        {
            ViewData["AnimalId"] = new SelectList(_context.Animal, "AnimalId", "Description");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Description,NutritionalInformation,Weight,Brand,TypeOfAnimal,AnimalId")] Food food)
        {
            ...
            ViewData["AnimalId"] = new SelectList(_context.Animal, "AnimalId", "Description", food.AnimalId);
            return View(food);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Description,NutritionalInformation,Weight,Brand,TypeOfAnimal,AnimalId")] Food food)
        {
            if (id != food.Id)
            {
                return NotFound();
