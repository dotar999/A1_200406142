...
{
    public class AnimalManagerController : Controller
    {
        private readonly ApplicationDbContext _context;

        public AnimalManagerController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: AnimalManager/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AnimalManager/Create
